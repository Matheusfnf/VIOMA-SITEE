      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <button className="bg-primary hover:bg-primary/90 text-white px-8 py-3 rounded-full text-lg font-semibold transition-colors w-full sm:w-auto">
                Explorar Soluções
              </button>
              <button className="border border-white/30 hover:border-white/50 text-white px-8 py-3 rounded-full text-lg font-semibold transition-colors backdrop-blur-sm w-full sm:w-auto">
                Saiba Mais
              </button>
            </motion.div>
          </motion.div>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              {floatingIcons.map(({ Icon, delay, position }, index) => (
                <motion.div
                  ...
                  className={`absolute ${position} bg-white/10 backdrop-blur-md p-3 rounded-full`}
                >
